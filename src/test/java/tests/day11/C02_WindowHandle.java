  ...
  //Tests package’inda yeni bir class olusturun: WindowHandle2
    ...
    public void windowHandleTest() {
     ...
     driver.get("https://the-internet.herokuapp.com/windows");
        ...
        softAssert.assertEquals(sayfadakiYaziElementi.getText(), "Opening a new window","sayfadaki yazi beklenenden farklı");
        ...
        //once acilan yeni sayfanın handle degerini elde etmeliyim
        ...
        softAssert.assertEquals(ikinciSayfadakiYaziElementi.getText(),"New Window", "2.yazi istenenden farkli");
        ...
        softAssert.assertEquals(driver.getTitle(),"The Internet","ilk sayfanin title i farkli");
